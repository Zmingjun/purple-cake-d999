...
[![Deploy to Cloudflare](https://deploy.workers.cloudflare.com/button)](https://deploy.workers.cloudflare.com/?url=https://github.com/cloudflare/templates/tree/main/purple-cake-d999)
...
```
npm create cloudflare@latest -- --template=cloudflare/templates/purple-cake-d999
```

A live public deployment of this template is available at [https://purple-cake-d999.templates.workers.dev](https://purple-cake-d999.templates.workers.dev)
